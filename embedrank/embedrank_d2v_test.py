...
from .embedrank_d2v import Doc2VecEmbedRank


class Doc2VecEmbedRankTest(unittest.TestCase):

    def testFromFile(self):
        input_file = '/opt/algo_nfs/kdd_luozhouyang/embedrank/part-00000.doc2vec.txt'
        model_path = '/opt/algo_nfs/kdd_luozhouyang/embedrank/doc2vec/20200409-2/model.doc2vec.100d.bin'
